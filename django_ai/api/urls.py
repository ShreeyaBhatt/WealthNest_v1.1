...
# As phases are completed, we'll uncomment these:
# from api.views import recommend, health_score
...
urlpatterns = [
    ...
    # path('recommend/', recommend.RecommendView.as_view(), name='recommend'),
    # path('health-score/', health_score.HealthScoreView.as_view(), name='health-score'),
